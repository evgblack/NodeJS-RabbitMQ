...
var log = loger_1.default.getLogger('M1');
var app = (0, express_1.default)();
var gateway = new Gateway_1.default({
    microservices: ['data'],
    rabbit: {
...
app.get('/status', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, gateway.delegate('data', req, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var port = (0, processenv_1.processenv)('PORT');
